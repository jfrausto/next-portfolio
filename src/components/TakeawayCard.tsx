  ...
  return (
    <>
      <Flex
        ...
        bg={"radial-gradient(circle at top center, rgba(208,138,138,0.38) 10%, rgba(56,67,100,0.40) 55%), radial-gradient(circle at center bottom, rgba(68,79,185,0.55) 4%, rgba(49,60,90,0.40) 60%)"}
        borderRadius={"2xl"}
      >
        {/* large icon */}
        <Icon
